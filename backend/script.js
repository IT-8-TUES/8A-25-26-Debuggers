...
function deleteTransactionQuestionfunc() {
    document.getElementById("transactionDetails").style.display = "block";
    document.getElementById("add_transaction").style.display = "none";
    document.getElementById("homepage").style.display = "none";
    document.getElementById("add_card").style.display = "none";
    ...
    document.getElementById("transactions").style.display = "none";
    document.getElementById("plusBtn").style.display = "none";
    document.getElementById("deleteTransactionQuestion").style.display = "block";
    deleteTransactionQuestionfunc();
...
function deleteTransaction()
{
    ...
    transactions.delete(transactionIndex);
    alert("Transaction deleted!");
    showTransactions();
}
